...
for (var i = 0; i < finances.length; i++) {
  for (var t = 0; t < finances[i].length; t++) {
    if (typeof finances[i][t] !== "string") {
      total += finances[i][t];
      change = finances[i][t] - net;
      net = finances[i][t];
...
console.log("Total highest: " + highest[0] + ' $' + highest[1] );
console.log("Total lowest: " + lowest[0] + ' $' + lowest[1] );
